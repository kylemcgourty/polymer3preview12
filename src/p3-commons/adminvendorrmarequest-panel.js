...
from '../../node_modules/@polymer/polymer/polymer-element.js'
  ...
  export class AdminVendorRMARequestPanel extends PolymerElement {
       ...
       .manage {
        ...
        <div class="title-rightpaneldraw"> Request </div>
                ...
                <template>
                    <div>
                        <div class="layout horizontal">
                            <iron-input class="col-xs-9 i-input" data-adminoff$="[[admin]]" id="term" on-tap="openChoice" bind-value="{{item.request}}">
                                <input disabled class="input">
                            </iron-input>
                            <iron-input class="col-xs-9 i-input admin1" data-admin$="[[admin]]" id="term" on-tap="openChoice" bind-value="{{item.request}}">
                                <input class="input">
                            </iron-input>
            ...
            <div>
                <div class="layout horizontal end">
                    <div class="submit button-row col-xs-9 admin" data-admin$="[[admin]]">
                        ...
                        <!-- <paper-button class="button main-button" on-tap="save" raised id="saveRequest">Submit</paper-button> -->
        ...
        //     console.log("this.$",this.$)
        //     // let choice = e.model.item.request
        //     this.dispatchEvent(new CustomEvent('vrmarequestlist',{
        //         bubbles: true,
        //         composed: true,
        //         detail: {
        //             requirement: "save",
        ...
        //         console.log("data in open panel func", data)
        ...
        open(branchname) {
                ...
                this.typemodel = "custrequests"
            } else if (branchname == "vendor"){
                this.typemodel = "vendrequests"
            }
    ...
    customElements.define("adminvendorrmarequest-panel", AdminVendorRMARequestPanel);
