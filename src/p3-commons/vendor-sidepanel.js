...
export class VendorSidepanel extends LitElement {
    ...
    selectVendor(item) {
        var vendor = item;
        var company = vendor.companyname;
        var vendorid = vendor.id;
        this.dispatchEvent(new CustomEvent('VendorEvent', {
            composed: true,
            bubbles: true,
            detail: {
                id: vendorid,
    ...
    open(profileid) {
        this.searchfields = {}
        this.searchfields.searchfield1 = "Vendor id"
        this.searchfields.searchfield2 = "Vendor"
        ...
        this.searchkeyindexes.searchkeyindex2 = "company_l"
    ...
    responselist(data, fromquery) {
        if (fromquery) {
                     ...
                     ${repeat (
                        ...
                        <div style="padding-bottom:24px">
                            <div class="row layout horizontal">
                                ...
                                <div on-tap="${() => this.selectVendor(item)}" class="layout vertical" style="width: 100%;">
                                    <div class="my-content">
                                        <div class="col-xs-3">Vendor:</div>
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.name }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                    ...
                                    <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.street }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.city }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.state }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.zip }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.to.phone }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                    ...
                                    <div class="my-content" >
                                     ...
                                     <div class="my-content" >
                                        ...
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.accountinfo.buyer }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-content" >
                                        <div class="col-xs-3">Buyer email: </div>
                                        <div class="text-right col-xs-9" style="float:right">
                                            <div>
                                                <input disabled class="input" value="${ item.accountinfo.email }">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            render(datatable(this.data, this.searchdisplay, this.searchkeyindexes, this.searchfields), this.shadowRoot.querySelector('#vendorpanel'))
...
customElements.define('vendor-sidepanel', VendorSidepanel);