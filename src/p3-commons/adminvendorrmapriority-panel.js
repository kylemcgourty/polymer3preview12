 ...
 from '../../node_modules/@polymer/polymer/polymer-element.js'
  ...
  export class AdminVendorRMAPriorityPanel extends PolymerElement {
...
/*            flex: 1 1 auto;
       ...
       .manage {
        ...
        <div class="title-rightpaneldraw"> Priority </div>
                ...
                <template>
                    <div>
                        <div class="layout horizontal">
                            <iron-input class="col-xs-9 i-input" data-adminoff$="[[admin]]" id="term" on-tap="openChoice" bind-value="{{item.priority}}">
                                <input disabled class="input">
                            </iron-input>
                            <iron-input class="col-xs-9 i-input admin1" data-admin$="[[admin]]" id="term" on-tap="openChoice" bind-value="{{item.priority}}">
                                <input class="input">
                            </iron-input>
        ...
        open(branchname) {
               ...
               if (branchname == "customer"){
                this.typemodel = "custpriorities"
            } else if (branchname == "vendor"){
                this.typemodel = "vendpriorities"
            }
        ...
        openChoice(e) {
            ...
            let choice = e.model.item.priority

            this.dispatchEvent(new CustomEvent('vrmapriority',{
                bubbles: true,
                composed: true,
                detail: {
                    item: choice,
    ...
    customElements.define('adminvendorrmapriority-panel', AdminVendorRMAPriorityPanel);
