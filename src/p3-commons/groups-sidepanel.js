...
export class GroupsSidepanel extends PolymerElement {
        ...
        <div class="title-rightpaneldraw">Groups </div>
                ...
                <template>
                    <div>
                        <div class="layout horizontal my-content">
                            <iron-input class="col-xs-9 i-input" data-adminoff$="[[admin]]" id="group" on-tap="openChoice" bind-value="{{item.group}}">
                                <input disabled class="input">
                            </iron-input>
                            <iron-input class="col-xs-9 i-input admin1" data-admin$="[[admin]]" id="group" on-tap="openChoice" bind-value="{{item.group}}">
                                <input class="input">
                            </iron-input>
   ...
   customElements.define("groups-sidepanel", GroupsSidepanel);
