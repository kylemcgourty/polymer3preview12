 ...
 from '../../node_modules/@polymer/polymer/polymer-element.js'
    ...
    export class AdminReturnReasonPanel extends PolymerElement {
 ...
 /*         #list {
       ...
       .manage {
        ...
        <div class="title-rightpaneldraw"> Return Reason </div>
                ...
                <template>
                    <div>
                        <div class="layout horizontal">
                            <iron-input class="col-xs-9 i-input" data-adminoff$="[[admin]]" id="returnreason" on-tap="openChoice" bind-value="{{item.returnreason}}">
                                <input disabled class="input">
                            </iron-input>
                            <iron-input class="col-xs-9 i-input admin1" data-admin$="[[admin]]" id="returnreason" on-tap="openChoice" bind-value="{{item.returnreason}}">
                                <input class="input">
                            </iron-input>
        ...
        adminchange(a) {
            console.log('admin has changed', a)
        }
        ...
        open(branchname) {
            if (branchname == "customer"){
                this.typemodel = "custreturnreasons"
            } else if (branchname == "vendor"){
                this.typemodel = "vendreturnreasons"
            }
        ...
        responseOption(request) {
            ...
            console.log("responseoption no problem")
            ...
            if (data != "") {
                ...
                this.data = [{
                    returnreason: "Over Stock"
                }, {
                    returnreason: "Dead on Arrival"
                }, {
                    returnreason: "Wrong Part"
                }, {
                    returnreason: "Damage"
                }, {
                    returnreason: "No Longer Need"
                }]
            }

            console.log("this.data at the end of RESPONSE OPTION", this.data)
        }
        ...
        openChoice(e) {
            ...
            let choice = e.model.item.returnreason

            this.dispatchEvent(new CustomEvent('returnreason', {
                bubbles: true,
                composed: true,
                detail: {
                    item: choice,
                    returnreasons: this.data
                }
...
customElements.define('adminreturnreason-panel', AdminReturnReasonPanel);
