...
export class APDistributedAccountsList extends LitElement {
    ...
    responseOption(request) {
        ...
        var data = request.detail.response.distributedaccounts
...
customElements.define("apdistributedaccounts-list", APDistributedAccountsList);