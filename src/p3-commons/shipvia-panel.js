  ...
  export class ShipVia extends LitElement {
          ...
          if (request) {
            ...
            ${repeat (
                 ...
                 item => html`
                               ...
                               <input disabled class="col-xs-9 i-input input" id$="${item.id}" value="${item.ship}" on-tap="${() =>this.openChoice(item)}">
                          `
                 )}
            <div>`;
              }
...
/*         #list {
  ...
  customElements.define('shipvia-panel', ShipVia);