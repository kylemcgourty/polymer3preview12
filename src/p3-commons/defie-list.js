...
import {Element as PolymerElement}
  ...
  export  class DefieList extends PolymerElement {
                                        ...
                                        <div class="core layout horizontal wrap">
                                            ...
                                            <div class="mobile-options layout horizontal">
                                                <div class="group5 layout horizontal wrap">
                                                    <div class="box5-data layout horizontal">
                                                        <div class="bd5-2">
                                                            <span class="bd5-1head"> [[col0]]</span>
                                            ...
                                            <div data-size$="[[item.col0.size]]" class="group2 layout horizontal wrap mobile-part">
                                                <div class="box2-data layout horizontal">
                                                    ...
                                                    <div class="bd2-2">
                                                        <iron-input style="display:[[editableCheck(item.col0.editable)]];" class="i-input" on-focusout="event00" bind-value="{{item.col0.value}}">
                                                            <input data-align$="[[item.col0.textalign]]" class="input1 col0input inputnum outline">
                                                        </iron-input>
                                                        <iron-input style="display:[[editableCheck1(item.col0.editable)]];" class="i-input" bind-value="{{item.col0.value}}">
                                            ...
                                            <div data-size$="[[item.col1.size]]" class="group1 layout horizontal wrap">
                                                <div class="box1-data layout horizontal">
                                                    ...
                                                    <div class="bd1-1 datapoint">
                                                        <iron-input style="display:[[editableCheck(item.col1.editable)]];" class="i-input" on-focusout="event11" bind-value="{{item.col1.value}}">
                                                            <input data-align$="[[item.col1.textalign]]" class="input1  inputnum outline">
                                                        </iron-input>
                                                        <iron-input style="display:[[editableCheck1(item.col1.editable)]];" class="i-input" bind-value="{{item.col1.value}}">
                                            ...
                                            <div data-size$="[[item.col2.size]]" class="group4 layout horizontal wrap">
                                                <div class="box4-data layout horizontal">
                                                    ...
                                                    <div class="bd4-1 datapoint">
                                                        <iron-input style="display:[[editableCheck(item.col2.editable)]];" class="i-input" on-focusout="event22" bind-value="{{item.col2.value}}">
                                                            <input data-align$="[[item.col2.textalign]]" class="inputnum input1 outline">
                                                        </iron-input>
                                                        <iron-input style="display:[[editableCheck1(item.col2.editable)]];" class="i-input" bind-value="[[item.col2.value]]">
        ...
        event22(e) {
            console.log("e in SOdefielist", e)
    ...
    customElements.define('defie-list', DefieList);
